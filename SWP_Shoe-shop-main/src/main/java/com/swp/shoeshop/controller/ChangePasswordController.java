...
public class ChangePasswordController extends HttpServlet {
    ...
    private static final String SUCCESS = "change-password.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!oldPassword.trim().equals(accDAO.getPassword(account.getId()))) {
            ...
            if (account != null) {
                ...
                if (!newPassword.trim().equals(confirmedPassword.trim())) {
                    ...
                    boolean check = accDAO.changePassword(newPassword, account.getId());
                    if (check) {
