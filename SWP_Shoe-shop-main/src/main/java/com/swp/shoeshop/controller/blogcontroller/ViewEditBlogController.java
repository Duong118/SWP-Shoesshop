 ...
 * @author Thuong
 */
@WebServlet(name = "ViewEditBlogController", urlPatterns = {"/ViewEditBlogController"})
public class ViewEditBlogController extends HttpServlet {

    private static final String ERROR = "error.jsp";
    private static final String EDIT_BLOG = "editblog.jsp";
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            try {
                ...
                News editBlog = dao.getNewsByID(id);
                request.setAttribute("EDIT_BLOG", editBlog);
                url = EDIT_BLOG;
            } catch (Exception ex) {
