    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            if (!urlPattern.matcher(img).find()) {
                ...
                if (checkValidation) {
                    Product product = new Product(id, name, img, originalPrice, discountPrice, description, shortdescript, point, cateid, 0, status);
            ...
            request.setAttribute("PRODUCT_ERROR", "Có lỗi xảy ra rồi .-.");
