...
public class GetCartController extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String action = request.getParameter("action"); //lấy action từ AddToCartController
            Cart cart = null;
            if (account != null) { //nếu user login
            ...
            //xử lý cho role user ko login (lưu cart trên cookie)
        } catch (Exception e) {
