            ...
            if (size > 0) {
                ...
                switch (size) {
                    case 1:
                        ...
                        break;
                    case 2:
                        error = errorArray.get(0) + " và " + errorArray.get(1);
                        break;
                    default:
                        ...
                        sb.deleteCharAt(sb.lastIndexOf(",")).append(" và ").append(errorArray.get(size - 1));
                        error = sb.toString();
                        break;
                }
                request.setAttribute("ERROR_AMOUNT", error + " exceeded stock quantity");
            }
